...
nametarget=hg19_Twist_exome_2_1_annotated_targets_sorted.canonical
targetfile=$here/NGS/Twist/hg19_Twist_exome_2_1_annotated_targets_sorted.canonical.bed
folder=$here/scripts_NGS_analysis/OFF-PEAK
...
folder=$here/scripts_NGS_analysis/OFF-PEAK
batch=unsolved-2022
bedFile=$here/NGS/Twist/hg19_Twist_exome_2_1_annotated_targets_sorted.canonical.bed
...
do
	sed "s|oouutt|$output|g" $script/config_default-2022.txt | sed "s|iinn|$here2\/$patient.dup.BQSR.bam|g" > $output/$patient.config.txt
...
targets=$here/refs/hg19_Twist_exome_2_1_annotated_targets_sorted.bed
